...
def create_sum_order_items_df(df):
    sum_order_items_df = df.groupby(by='product_name').quantity_x.sum().sort_values(ascending=False).reset_index()
...
# code for best and worst performing product
# =================================================================
...
# for RFM (Recency, Frequency, Monetary) Parameter
# =================================================================
